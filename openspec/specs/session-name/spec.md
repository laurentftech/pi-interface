...
How a saved session acquires a display name: auto-generated from the first exchange, renameable
and clearable by the user, persisted in the session file so the session menu reads as a list of
topics rather than a pile of opening lines.
