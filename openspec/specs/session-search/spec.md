...
Finding a saved session by its name, its first message, or anything ever said in it. Matching runs
server-side over the full transcript; each result carries the excerpt that explains why it matched.
